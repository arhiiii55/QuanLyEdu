    ...
    <div id="main">
            ...
            <ul>
              ...
              <li class="submenu">
                <a href="mail-all.html">
                  <span class="label radius-circle bg-danger float-right"
                    >18</span
                  >
              ...
              <li class="submenu">
                ...
                <ul class="list-unstyled">
                  <li class="active">
                    <a class="active" href="forms-general.html"
                      >General Elements</a
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="forms-datetime-picker.html"
                      >Date and Time Picker</a
                    >
                  </li>
                  <li>
              ...
              <li class="submenu">
                <a href="#">
                  <span class="label radius-circle bg-primary float-right"
                    >9</span
                  >
          ...
          <div class="container-fluid">
            ...
            <div class="alert alert-success" role="alert">
              ...
              <p>
                ...
                <a
                  target="_blank"
                  href="http://getbootstrap.com/docs/4.3/components/forms/"
                  >Bootstrap Forms Documentation</a
                >
              </p>
            </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    ...
                    Be sure to use an appropriate <i>type</i> attribute on all
                    inputs (e.g., <i>email</i> for email address or
                    <i>number</i> for numerical information) to take advantage
                    of newer input controls like email verification, number
                    selection, and more.
                  </div>
                  ...
                  <div class="card-body">
                    <form>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1"
                          >Your lucky number (required)</label
                        >
                        <input
                          type="number"
                          class="form-control"
                          ...
                          required
                        />
                        <small id="numberlHelp" class="form-text text-muted"
                          >We'll never share your email with anyone else.</small
                        >
                      </div>
                      <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    <h3>
                      <i class="far fa-check-square"></i> Sizing and Readonly
                    </h3>
                    Set heights using classes like <i>.form-control-lg</i> and
                    <i>.form-control-sm</i>. Add the <i>readonly</i> boolean
                    attribute on an input to prevent modification of the input's
                    value.
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    ...
                    <i>.row</i> class to form groups and using the
                    <i>.col-*-*</i> classes to specify the width of your labels
                    and controls.
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    ...
                    Use the <i>.form-inline</i> class to display a series of
                    labels, form controls, and buttons on a single horizontal
                    row. Form controls within inline forms vary slightly from
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    ...
                    <i>.form-text</i> (previously known as <i>.help-block</i> in
                    v3). Inline help text can be flexibly implemented using any
                    inline HTML element and utility classes like
                    <i>.text-muted</i>.
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    ...
                    fields with <i>.is-invalid</i> and <i>.is-valid</i>. Note
                    that <i>.invalid-feedback</i> is also supported with these
                    classes.
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card mb-3">
                  <div class="card-header">
                    <h3>
                      <i class="far fa-check-square"></i> Supported elements
                    </h3>
                    Our example forms show native textual <i>input</i> above,
                    but form validation styles are available for our custom form
                    controls, too.
                  </div>
      ...
      <footer class="footer">
        ...
        <span class="float-right">
          ...
          <a
            target="_blank"
            href="https://bootstrap24.com"
            title="Download free Bootstrap templates"
            ><b>Bootstrap24.com</b></a
          >
        </span>
      </footer>
