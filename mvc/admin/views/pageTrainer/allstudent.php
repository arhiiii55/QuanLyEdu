                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <a href="Home2/studentPage" class="">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="dataTable" class="table table-bordered table-hover display"
                                                    ...
                                                    <?php
                                                    $i = 1;
                                                    while ($row = mysqli_fetch_assoc($data["showstudent"])) {
                                                    ?>
                                                    <tbody>
                                                        <tr>
                                                            <th><?php echo $row["id_students"] ?></th>
                                                            <th> <img style="width: 80px;"
                                                                    src="mvc\photo\<?php echo $row["imgHV"] ?>" alt=""
                                                ...
                                                <table id="dataTable" class="table table-bordered table-hover display"
                                                    ...
                                                    <tbody>
                                                        <tr><?php $i++; ?>
                                                            ...
                                                            <td><a href="Home2/student_incourse_delete/<?php echo $row1["id_students"]; ?>"
